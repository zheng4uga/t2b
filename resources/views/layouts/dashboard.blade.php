              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="employeeDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                 ...
                 <div class="dropdown-menu" aria-labelledby="employeeDropdown">
                  <a class="dropdown-item" href="{{url('/shift/request')}}">Request Shift Pickup</a>
                  @if(Auth::user()->memberType->memberGroup->group_name == 'Area Manager')
                    <a class="dropdown-item" >Grant Overtime</a>
                    <a class="dropdown-item">Set Manager</a>
                  @endif
                  @if(Auth::user()->memberType->memberGroup->group_name == 'Area Manager' || 
                  Auth::user()->memberType->memberGroup->group_name == 'Manager')
                    <a class="dropdown-item">Assign Employee</a>
                    <a class="dropdown-item" href="">Add/Remove Employee</a>
                    <a class="dropdown-item" href="pickup-inactive.html">Change employee status</a>
                  @endif
